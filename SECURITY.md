...
PHOENIX CONTACT takes the security of the ngx-web-framework and its downstream products seriously.
...
`@moryx/ngx-web-framework` follows the [Angular release schedule](https://angular.dev/reference/releases).
The library's major version matches the Angular major version it targets.
...
|---------|---------------------|------------------------|
| 22.x    | Active Support      | ~ Nov 2027             |
| 20.x    | Maintenance Support | ~ Nov 2026             |
| < 20.0  | End of Life         | —                      |
...
- Type of vulnerability (e.g. XSS, dependency confusion, prototype pollution)
...
Published security advisories for ngx-web-framework are available in the [GitHub Security Advisories](../../security/advisories) section of this repository.
...
This policy covers the source code in this repository (`PHOENIXCONTACT/ngx-moryx-web`).

If you are building a product or extension on top of `@moryx/ngx-web-framework`, you are responsible for the security of your own code and for monitoring your additional dependencies for known CVEs. Please refer to our [security integration guidelines](https://github.com/PHOENIXCONTACT/MORYX-Home/blob/main/guidelines/security-guidelines.md) for recommended practices.

Under the [EU Cyber Resilience Act (CRA)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R2847), products with digital elements that incorporate `@moryx/ngx-web-framework` are subject to Article 13 obligations, including providing security updates for the expected product lifetime (minimum five years).
